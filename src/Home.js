...
import MyMintCollection from "./MyMintCollection";
    ...
    if (acc == "No Wallet") {
      ...
      try {
        ...
        if (length < 7) {
          ...
          toast.error("Minting limit reached");
        }
      } catch (e) {
    ...
    <div className="home">
      ...
      <div className="col-lg-8 col-11 mb-md-1 mb-4 mt-4">
        {modalShow ? (
          ...
          //   >
          //     <MintModal mintArray={mintArray} onHide={onHide} />
          //   </Modal.Body>
          // </Modal>
          <MintModal mintArray={mintArray} acc={acc} />
        ) : (
          // <Modal
          //   show={modalShow}
          //   onHide={() => setModalShow(false)}
      ...
      <div className="col-lg-8 col-11 mb-md-1 mb-4 mt-4">
        {collectionModalShow ? (
          ...
          // </Modal>
          <MyMintCollection
            mintCollectionArray={mintCollectionArray}
            acc={acc}
          />
        ) : (
          // <Modal
